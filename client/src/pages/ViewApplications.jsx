...
//import { changeJobApplicationsStatus } from '../controllers/companyControllers'
//import { changeJobApplicationsStatus } from '../../../server/controllers/companyControllers'
...
//     const [applicants, setApplicants] = useState(null) // updated from false to null
...
//                 setApplicants([...data.applicants].reverse()) // safe reverse
//             } else {
//                 toast.error(data.message || "Unexpected response format")
//             }
//         } catch (error) {
...
//         <Loading />
//     ) : applicants.length === 0 ? (
//         <div className='text-center mt-8 text-gray-500'>No applicants found.</div>
//     ) : (
